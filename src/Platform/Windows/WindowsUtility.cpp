...
std::variant<std::string, std::wstring> Fyuu::windows_util::ConvertString(std::string const& str) {
...
std::string Fyuu::windows_util::WStringToString(std::wstring const& wstr) {
