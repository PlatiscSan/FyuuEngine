...
export namespace core {
	...
	class YAMLConfig : public BaseConfig {
	private:
		static typename ConfigNode::ConfigValue ParseYAMLNode(YAML::Node const& yaml_node) {
	...
	public:
		...
		YAMLConfig(Node&& node)
			: BaseConfig(std::forward<Node>(node)) {
